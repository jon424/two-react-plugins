...
/*
  Plugin Name: Jon&rsquo;s Boilerplate Block Plugin
  Version: 1.0
  Author: Brad
...
class secondPlugin {
  ...
  function renderCallback($attributes) {
    ...
    ob_start(); ?>
    <div class="boilerplate-update-me-too"><pre style="display: none;"><?php echo wp_json_encode($attributes) ?></pre></div>
    <?php return ob_get_clean();
    
  }

  function renderCallbackBasic($attributes) {
    //    return '<div class="boilerplate-frontend-2">!</div>';
    return '<div />';
  }
}

$secondPlugin = new secondPlugin();